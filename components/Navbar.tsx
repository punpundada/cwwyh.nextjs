...
const Navbar = () => {
  ...
  return (
    <nav id="nav" className="navbar fixed top-0 left-0  transition-transform duration-500 ease-in-out w-screen   bg-app-secondary h-20 flex justify-between items-center text-2xl font-semibold ">
      <div className="flex ms-8">
        <Image className="" src={logo2} alt="LOGO" width={160} height={160} loading="lazy" />
        <h1>CWWYH</h1>
      </div>
